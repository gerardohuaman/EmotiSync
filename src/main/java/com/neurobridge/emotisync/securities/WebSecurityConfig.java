...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        // ✅ IMPORTANTE: Habilitar CORS ANTES que las reglas
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers("/sintomas/**").permitAll() // ✅ permite todos los métodos del endpoint
                        // swagger
    ...
    // ✅ MÉTODO NUEVO: configuración CORS global
    @Bean
    public CorsConfigurationSource corsConfigurationSource() {
        CorsConfiguration configuration = new CorsConfiguration();

        // 👇 Asegúrate de usar el mismo puerto que usa tu Angular
